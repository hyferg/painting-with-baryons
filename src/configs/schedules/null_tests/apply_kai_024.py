...
schedule['g_optim_opts']['lr'] = 1e-5
schedule['d_optim_opts']['lr'] = 1e-5
schedule['save_summary']['iters'] = [5, 10, 25, 35] + np.arange(0, 350, 50).tolist() + np.arange(350, 10000, 100).tolist()
