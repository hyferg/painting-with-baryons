...
from src.configs.resnet.dim256x1xaviergain1Leaky import g_structure
...
schedule['g_optim_opts']['lr'] = 2e-5
schedule['d_optim_opts']['lr'] = 2e-5
schedule['save_summary']['iters'] = [1, 2, 3, 5, 10, 35] + np.arange(0, 350, 50).tolist() + np.arange(350, 10000, 100).tolist()

schedule['loss_params']['l1_lambda'] = 10
schedule['loss_params']['grade_lambda'] = 1e3
...
g_structure['decode_stack']['filters'][-1]['init_gain'] = 0.3
