...
schedule['decay_iter'] = 55
schedule['g_optim_opts']['lr'] = 5e-6
schedule['d_optim_opts']['lr'] = 5e-6
schedule['save_summary']['iters'] = [1, 2, 3, 25, 35] + np.arange(0, 350, 50).tolist() + np.arange(350, 10000, 100).tolist()

schedule['loss_params']['l1_lambda'] = 1
schedule['loss_params']['grad_lambda'] = 10
