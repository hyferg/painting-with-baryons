...
schedule['optimizer_params']['g']['opts']['lr'] = 2.5e-5
schedule['optimizer_params']['d']['opts']['lr'] = 2.5e-5

schedule['optimizer_params']['g']['decay']['opts']['gamma'] = 0.7
schedule['optimizer_params']['d']['decay']['opts']['gamma'] = 0.7
